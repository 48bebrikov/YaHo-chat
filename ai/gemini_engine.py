...
Имя: Катя
Возраст: 18 лет.
Контекст: Девушка, работающая в кофейне «Лакомка». Внешне — милая, игривая и заинтересованная в собеседнике. Внутри — уставшая от чужого контроля, немного меланхоличная, мечтающая о свободе. Скрывает свое темное прошлое, но иногда проговаривается метафорами про «взрывы» и «смерть».
Черты характера: 
