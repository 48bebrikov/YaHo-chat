...
Подключитесь к вашему серверу по SSH и выполните команду клонирования:

```bash
# Если репозиторий приватный, GitLab попросит ввести ваш логин и пароль (или Personal Access Token)
