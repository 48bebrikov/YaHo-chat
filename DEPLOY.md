...
Здесь описаны шаги для запуска проекта локально через Docker, а также для пуша (отправки) вашего кода в удаленный репозиторий GitLab ([https://gitlab.com/yoho7930516/yoho-chat](https://gitlab.com/yoho7930516/yoho-chat)).
